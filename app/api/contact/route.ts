    ...
    const template = handlebars.compile(`<html lang="en">
          ...
          <body>
            <div class="container">
              ...
              <div class="footer">
                <p>For any inquiries, contact us at <a href="mailto:info@maximabusinesssolutions.com">info@maximabusinesssolutions.com</a> or call <a href="tel:+919657480645">+91 9657480645</a></p>
              </div>
            </div>
          </body>
        </html>
`);
    ...
    const userTemplate = handlebars.compile(`<html lang="en">
          <head>
            <meta charset="UTF-8" />
            <meta name="viewport" content="width=device-width, initial-scale=1.0" />
          ...
          <body>
            <div class="container">
              ...
              <div class="content">
                <p>Dear ${fullName},</p>
                <p>Thank you for contacting Maxima Business Solutions. We have received your message and our team will get back to you as soon as possible.</p>
                ...
                <p style="margin-top: 20px;">Best regards,<br>The Maxima Business Solutions Team</p>
              </div>
...
`);
    ...
    const userHtmlToSend = userTemplate({
      fullName,
      subject,
      message,
    });
    ...
    await client.sendMail({
      ...
      subject: "Thank You for Contacting Us - Maxima Business Solutions",
      htmlbody: userHtmlToSend,
    });
