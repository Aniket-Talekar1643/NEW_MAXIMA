    ...
    <footer className="bg-background/95 backdrop-blur-md text-muted-foreground pt-14 sm:pt-16 pb-6 sm:pb-8 border-t border-border/10">
      <div className="container mx-auto px-6 md:px-12 lg:px-16">
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10 md:gap-12 mb-10 sm:mb-12">
          ...
          <div className="col-span-2 lg:col-span-1 flex flex-col gap-4">
            ...
            <h1 className="text-sm leading-relaxed">
              A leading software development company in Pune providing custom
              software solutions, MERN stack development, digital marketing, and
              ...
              {[
                {
                  Icon: Facebook,
                  label: "Facebook",
                  href: "https://www.facebook.com/maximabusinesssolutions/",
                },
                {
                  Icon: Twitter,
                  label: "Twitter",
                  href: "https://x.com/maximabusiness",
                },
                {
                  Icon: Instagram,
                  label: "Instagram",
                  href: "https://www.instagram.com/maximabusinesssolutions?igsh=MTYyc3BqYjVibXJ5Yg==",
                },
                {
                  Icon: Linkedin,
                  label: "LinkedIn",
                  href: "https://www.linkedin.com/company/maxima-business-solutions",
                },
              ].map(({ Icon, label, href }) => (
                <Link
                  key={label}
          ...
          {/* Quick Links */}
          <div>
            <h3 className="text-foreground font-semibold mb-4 sm:mb-6 text-sm">
              Company
            </h3>
          ...
          <div>
            ...
            <ul className="flex flex-col gap-2.5 text-xs sm:text-sm">
              {[
                {
                  href: "/software-development-services-pune#web-dev",
                  label: "Web & Mobile App Dev",
                },
                {
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <ul className="space-y-6">
              ...
              <li className="flex items-center gap-4 group">
                <Link
                  href="mailto:info@maximabusinesssolutions.com"
                  className="flex items-center gap-4 w-full"
                >
                  <div className="w-10 h-10 rounded-xl bg-primary/10 flex items-center justify-center text-primary group-hover:bg-primary group-hover:text-white transition-all">
                    <Mail size={18} />
                  ...
                  <span className="text-muted-foreground text-sm group-hover:text-primary transition-colors">
                    info@maximabusinesssolutions.com
                  </span>
                </Link>
              </li>
            </ul>
        ...
        <div className="pt-6 sm:pt-8 border-t border-white/5 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-muted-foreground/60">
          <p>
            © {new Date().getFullYear()} Maxima Business Solutions. All rights
            reserved.
          </p>
