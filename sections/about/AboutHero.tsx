            ...
            <div className="container mx-auto px-6 md:px-12 lg:px-16 text-center relative z-10">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 !leading-tight tracking-tight">
                        Your Trusted <span className="text-primary">IT Outsourcing <span className="relative inline-block">Agency
                            <motion.svg className="absolute  -bottom-4 md:-bottom-5 lg:-bottom-8 left-0 w-full" viewBox="0 0 100 20" preserveAspectRatio="none">
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                        Partner with Maxima Business Solutions, a leading IT outsourcing agency in Pune. 
                        We focus on digital transformation and technical excellence—empowering 
                        enterprises with future-ready custom software solutions.
                    </p>
                </motion.div>
            </div>
