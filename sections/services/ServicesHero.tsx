            ...
            <div className="container mx-auto px-6 md:px-12 lg:px-16 text-center relative z-10">
                ...
                >
                    ...
                    <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-8 !leading-tight tracking-tight">
                        Expert Web & Mobile App <br className="hidden md:block" />Development Services in <span className="text-primary relative inline-block">
                            Pune
                    ...
                    <p className="text-lg md:text-xl text-muted-foreground leading-relaxed max-w-3xl mx-auto">
                        We deliver robust web and mobile app development services in Pune. From MERN stack web applications to native mobile apps, our solutions are built for global scale.
                    </p>
                </motion.div>
            </div>
