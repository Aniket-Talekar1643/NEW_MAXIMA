...
export const Keypad = () => {
  return (
    <div className="h-full w-fit rounded-xl p-1 shadow-sm ring-1 shadow-black/5 ring-black/5">
      {/* Function Row */}
      <Row>
        <Key
          keyCode="Escape"
        ...
        <Key containerClassName="rounded-tr-xl" className="rounded-tr-lg">
          <div className="h-4 w-4 rounded-full p-px">
          </div>
        </Key>
      </Row>
  ...
  return (
    <div className={cn("rounded-[4px] p-[0.5px]", containerClassName)}>
      <button
        ...
        className={cn(
          "flex h-6 w-6 cursor-pointer items-center justify-center rounded-[3.5px] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.5),0px_1px_1px_0px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(255,255,255,1)_inset] transition-transform duration-75 active:scale-[0.98]",
          isPressed &&
            "scale-[0.98] shadow-[0px_0px_1px_0px_rgba(0,0,0,0.5),0px_1px_1px_0px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(255,255,255,0.5)]",
          className,
        )}
      >
        <div
          className={cn(
            "flex h-full w-full flex-col items-center justify-center text-[5px] text-white",
            childrenClassName,
          )}
        >
          {children}
...
const ModifierKey = ({
  ...
  return (
    <div className={cn("rounded-[4px] p-[0.5px]", containerClassName)}>
      ...
      >
        <div className="flex h-full w-full flex-col items-start justify-between p-1 text-[5px] text-white">
          {children}
        </div>
      </button>
    </div>
